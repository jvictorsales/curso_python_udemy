...
if entrada_e_sequencial:
    print('Você enviou um CPF com valores sequenciais.')
    sys.exit()
...
for digito in nove_digitos:
    resultado_digito_1 += int(digito) * contador_regressivo_digito_1
...
for digito in dez_digitos:
    resultado_digito_2 += int(digito) * contador_regressivo_digito_2
